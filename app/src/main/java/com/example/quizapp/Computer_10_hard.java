...
public class Computer_10_hard extends AppCompatActivity {
    ...
    private void getData() {
        ...
        qlist.add(new ComicsModel(
                "What was the name of the security vulnerability found in Bash in 2014?", 4, "Heartbleed", "Bashbug", "Stagefright", "Shellshock"));

        qlist.add(new ComicsModel(
                "The internet domain .fm is the country-code top-level domain for which Pacific Ocean island nation?", 2, "Fiji", "Micronesia", "Tuvalu", "Marshall Islands"));

        qlist.add(new ComicsModel(
                "What port does HTTP run on?", 3, "53", "443", "80", "23"));

        qlist.add(new ComicsModel(
                "America Online (AOL) started out as which of these online service providers?", 1, "Quantum Link", "CompuServe", "Prodigy", "GEnie"));

        qlist.add(new ComicsModel(
                "What is the name given to layer 4 of the Open Systems Interconnection (ISO) model?", 1, "Transport", "Session", "Data link", "Network"));

        qlist.add(new ComicsModel(
                "According to DeMorgan's Theorem, the Boolean expression (AB)' is equivalent to:", 2, "A'B + B'A", "A' + B'", "A'B'", "AB' + AB"));
        ...
        qlist.add(new ComicsModel(
                "What type of sound chip does the Super Nintendo Entertainment System (SNES) have?", 4, "FM Synthesizer", "Programmable Sound Generator (PSG)", "PCM Sampler", "ADPCM Sampler"));

        qlist.add(new ComicsModel(
                "Which of the following computer components can be built using only NAND gates?", 3, "CPU", "RAM", "ALU", "Register"));

        qlist.add(new ComicsModel(
                "Which of these Cherry MX mechanical keyboard switches is both tactile and clicky?", 2, "Cherry MX Black", "Cherry MX Blue", "Cherry MX Red", "Cherry MX Brown"));
    ...
    private void changequestion() {
        ...
        {
            Intent intent  = new Intent(Computer_10_hard.this,MainActivity.class);
