...
public class Computer_10_medium extends AppCompatActivity
{
    ...
    private void getData() {
        ...
        qlist.add(new ComicsModel(
                "What does AD stand for in relation to Windows Operating Systems? ", 2, "Alternative Drive", "Active Directory", "Automated Database", "Active Department"));

        qlist.add(new ComicsModel(
                "What was the first commerically available computer processor?", 3, "Intel 486SX", "TMS 1000", "Intel 4004", "AMD AM386"));

        qlist.add(new ComicsModel(
                "While Apple was formed in California, in which western state was Microsoft founded?", 1, "New Mexico", "Washington", "Colorado", "Arizona"));

        qlist.add(new ComicsModel(
                "In HTML, which non-standard tag used to be be used to make elements scroll across the viewport?", 4, "<scroll></scroll>", "<move></move>", "<slide></slide>", "<marquee></marquee>"));

        qlist.add(new ComicsModel(
                "Which operating system was released first?", 2, "Windows", "Mac OS", "Linux", "OS/2"));

        qlist.add(new ComicsModel(
                "Which of these people was NOT a founder of Apple Inc?", 2, "Steve Jobs", "Jonathan Ive", "Ronald Wayne", "Steve Wozniak"));

        qlist.add(new ComicsModel(
                "Laserjet and inkjet printers are both examples of what type of printer?", 3, "Impact printer", "Daisywheel printer", "Non-impact printer", "Dot matrix printer"));

        qlist.add(new ComicsModel(
                "Approximately how many Apple I personal computers were created?", 2, "100", "200", "500", "1000"));

        qlist.add(new ComicsModel(
                "How many bytes are in a single Kibibyte?", 4, "2400", "1000", "1240", "1024"));

        qlist.add(new ComicsModel(
                "The teapot often seen in many 3D modeling applications is called what?", 2, "Pixar Teapot", "Utah Teapot", "3D Teapot", "Tennessee Teapot"));
    ...
    private void changequestion() {
        ...
        {
            Intent intent  = new Intent(Computer_10_medium.this,MainActivity.class);
