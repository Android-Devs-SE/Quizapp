...
public class Nature_10_easy extends AppCompatActivity {
    ...
    private void getData() {
        ...
        qlist.add(new ComicsModel(
                "Which element has the chemical symbol 'Fe'?", 2, "Gold", "Iron", "Silver", "Tin"));

        qlist.add(new ComicsModel(
                "What is the 'powerhouse' of the Eukaryotic animal cell?", 2, "Nucleus", "Mitochondria", "Chloroplast", "Endoplasmic Reticulum"));

        qlist.add(new ComicsModel(
                "What is the elemental symbol for mercury?", 3, "Me", "Mc", "Hg", "Hy"));

        qlist.add(new ComicsModel(
                "How many planets are in our Solar System?", 3, "Nine", "Seven", "Eight", "Ten"));

        qlist.add(new ComicsModel(
                "Which gas forms about 78% of the Earth’s atmosphere?", 3, "Oxygen", "Argon", "Nitrogen", "Carbon Dioxide"));

        qlist.add(new ComicsModel(
                "How many planets make up our Solar System?", 2, "7", "8", "9", "6"));

        qlist.add(new ComicsModel(
                "The human heart has how many chambers?", 2, "2", "4", "6", "3"));

        qlist.add(new ComicsModel(
                "What is the standard atomic weight of a Plutonium nucleus?", 1, "244", "94", "481", "128"));

        qlist.add(new ComicsModel(
                "Which noble gas has the lowest atomic number?", 1, "Helium", "Neon", "Argon", "Krypton"));

        qlist.add(new ComicsModel(
                "Dry ice is the solid form of what substance?", 3, "Nitrogen", "Ammonia", "Carbon dioxide", "Oxygen"));
    ...
    private void changequestion() {
        ...
        {
            Intent intent  = new Intent(Nature_10_easy.this,MainActivity.class);
