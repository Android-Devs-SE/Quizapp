...
public class Anime_10_easy extends AppCompatActivity {
    ...
    private void getData() {
        ...
        qlist.add(new ComicsModel(
                "Which anime heavily features music from the genre 'Eurobeat'?", 1, "Initial D", "Wangan Midnight", "Kino no Tabi", "Cowboy Bebop"));

        qlist.add(new ComicsModel(
                "Who was given the title 'Full Metal' in the anime series 'Full Metal Alchemist'?", 3, "Alphonse Elric", "Van Hohenheim", "Edward Elric", "Izumi Curtis"));

        qlist.add(new ComicsModel(
                "What is the last name of Edward and Alphonse in the Fullmetal Alchemist series.", 3, "Ellis", "Eliek", "Elric", "Elwood"));

        qlist.add(new ComicsModel(
                "What is the name of the corgi in Cowboy Bebop?", 4, "Edward", "Rocket", "Joel", "Einstein"));

        qlist.add(new ComicsModel(
                "What is the name of the stuffed lion in Bleach?", 4, "Jo", "Urdiu", "Chad", "Kon"));

        qlist.add(new ComicsModel(
                "In 'Fairy Tail', what is the nickname of Natsu Dragneel?", 4, "The Dragon Slayer", "The Dragon", "The Demon", "The Salamander"));

        qlist.add(new ComicsModel(
                "What is the age of Ash Ketchum in Pokemon when he starts his journey?", 4, "11", "12", "9", "10"));

        qlist.add(new ComicsModel(
                "Who is the true moon princess in Sailor Moon?", 3, "Sailor Venus", "Sailor Mars", "Sailor Moon", "Sailor Jupiter"));

        qlist.add(new ComicsModel(
                "What was Ash Ketchum's second Pokemon?", 4, "Charmander", "Pikachu", "Pidgey", "Caterpie"));

        qlist.add(new ComicsModel(
                "Who is the main character with yellow hair in the anime Naruto?", 1, "Naruto", "Ten Ten", "Sasuke", "Kakashi"));
    ...
    private void changequestion() {
        ...
        {
            Intent intent  = new Intent(Anime_10_easy.this,MainActivity.class);
