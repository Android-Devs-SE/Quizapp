...
public class Film_10_medium extends AppCompatActivity {
    ...
    private void getData()
    {
        qlist.add(new ComicsModel(
                "Which 1958 movie starred Kirk Douglas and Tony Curtis as half-brothers Einar and Eric?", 1, "The Vikings ", "The Long Ships", "Prince Valiant", "Spartacus"));

        qlist.add(new ComicsModel(
                "Velma Kelly and Roxie Hart are the protagonists of which Oscar winning movie?", 4, "Dreamgirls", "Cabaret", "All That Jazz", "Chicago"));

        qlist.add(new ComicsModel(
                "What is the name of James Dean's character in the 1955 movie 'Rebel Without a Cause'?", 3, "Ned Stark", "Jim Kane", "Jim Stark", "Frank Stark"));

        qlist.add(new ComicsModel(
                "What is the name of the robot in the 1951 science fiction film classic 'The Day the Earth Stood Still'?", 4, "Robby", "Colossus", "Box", "Gort"));

        qlist.add(new ComicsModel(
                "This movie contains the quote, 'I love the smell of napalm in the morning!'", 2, "Platoon", "Apocalypse Now", "The Deer Hunter", "Full Metal Jacket"));

        qlist.add(new ComicsModel(
                "In what year was the first Transformers movie released?", 3, "2007", "1984", "1986", "2009"));

        qlist.add(new ComicsModel(
                "Which movie sequel had improved box office results compared to its original film?", 2, "Sin City: A Dame to Kill For", "Toy Story 2", "Speed 2: Cruise Control", "Son of the Mask"));

        qlist.add(new ComicsModel(
                "Which iconic character is featured in movies such as 'The Enforcer', 'Sudden Impact', and 'The Dead Pool'?", 3, "Indiana Jones", "James Bond", "Dirty Harry", "Harry Potter"));

        qlist.add(new ComicsModel(
                "In the 1971 film 'Willy Wonka & the Chocolate Factory', who played Willy Wonka?", 2, "Shia LeBouf", "Gene Wilder", "Peter Ostrum", "Johnny Depp"));

        qlist.add(new ComicsModel(
                "Who plays the Nemesis in the Resident Evil movies?", 4, "Jason Dip", "Eric Mabius", "Jimmy Matts", "Matthew Taylor"));
        setQuestion();
    }
    ...
    private void changequestion() {
        ...
        {
            Intent intent  = new Intent(Film_10_medium.this,MainActivity.class);
