...
public class Sports_10_hard extends AppCompatActivity {
    ...
    private void getData() {
        ...
        qlist.add(new ComicsModel(
                "How many times did Martina Navratilova win the Wimbledon Singles Championship?", 3, "Ten", "Seven", "Nine", "Eight"));

        qlist.add(new ComicsModel(
                "What tool lends it's name to a last-stone advantage in an end in Curling?", 2, "Wrench", "Hammer", "Drill", "Screwdriver"));

        qlist.add(new ComicsModel(
                "Which car company is the only Japanese company which won the 24 Hours of Le Mans?", 2, "Toyota", "Mazda", "Subaru", "Nissan"));

        qlist.add(new ComicsModel(
                "Which Italian footballer told Neuer where he's putting his shot and dragging it wide, during the match Italy-Germany, UEFA EURO 2016?", 2, "Insigne", "Pelle", "Barzagli", "Giaccherini"));
        ...
        qlist.add(new ComicsModel(
                "Which female player won the gold medal of table tennis singles in 2016 Olympics Games?", 1, "DING Ning (China)", "LI Xiaoxia (China)", "Ai FUKUHARA (Japan)", "Song KIM (North Korea)"));
        ...
        qlist.add(new ComicsModel(
                "Who is Manchester United's leading appearance maker?", 3, "David Beckham", "Wayne Rooney", "Ryan Giggs", "Eric Cantona"));

        qlist.add(new ComicsModel(
                "The Mazda 787B won the 24 Hours of Le Mans in what year?", 3, "1990", "2000", "1991", "1987"));

        qlist.add(new ComicsModel(
                "The AHL affiliate team of the Boston Bruins is named what?", 3, "New Haven Bruins", "Cambridge Bruins", "Providence Bruins", "Hartford Bruins"));
    ...
    private void changequestion() {
        ...
        {
            Intent intent  = new Intent(Sports_10_hard.this,MainActivity.class);
