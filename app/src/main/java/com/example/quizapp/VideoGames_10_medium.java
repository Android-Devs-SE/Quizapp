...
public class VideoGames_10_medium extends AppCompatActivity {
    ...
    private void getData() {
        qlist.add(new ComicsModel(
                "Killing Floor started as a mod for which Unreal Engine 2 game?", 2, "Deus Ex: Invisible War", "Unreal Tournament 2004", "Unreal Tournament 3", "Postal"));

        qlist.add(new ComicsModel(
                "What was the character Kirby originally going to be named?", 3, "Dedede", "Waddle Dee", "Popopo", "Prince Puff"));

        qlist.add(new ComicsModel(
                "Which character is from 'Splatoon'?", 4, "Cyrus", "Palutena", "Shulk", "Marie"));

        qlist.add(new ComicsModel(
                "Just Cause 2 was mainly set in what fictional Southeast Asian island country?", 1, "Panau", "Davao", "Macau", "Palau"));

        qlist.add(new ComicsModel(
                "Which of these games was the earliest known first-person shooter with a known time of publication?", 3, "Doom", "Wolfenstein", "Spasim", "Quake"));

        qlist.add(new ComicsModel(
                "Which was the first video game to be produced by development company Rare?", 3, "R.C. Pro-Am", "Donkey Kong Country", "Slalom", "Battletoads"));

        qlist.add(new ComicsModel(
                "In the 2002 video game 'Kingdom Hearts', how many playable worlds were there?", 1, "14", "13", "16", "11"));

        qlist.add(new ComicsModel(
                "Which puzzle game was designed by a Russian programmer, featuring Russian buildings and music?", 1, "Tetris", "Jenga", "Boulder Dash", "Puzzled"));

        qlist.add(new ComicsModel(
                "In the Portal series, Aperture Science was founded under what name in the early 1940s?", 3, "Aperture Lavatories", "Aperture Science Innovators", "Aperture Fixtures", "Wheatley Laboratories"));

        qlist.add(new ComicsModel(
                "Which of these is the name of a cut enemy from 'Half-Life 2'?", 4, "Cthulu", "Spike", "Tremor", "Hydra"));
    ...
    private void changequestion() {
        ...
        {
            Intent intent  = new Intent(VideoGames_10_medium.this,MainActivity.class);
